...
def plot_gaussians(persons, group_pose, group_radius, N = 200,show_group_space = TRUE, xmin,xmax, ymin, ymax):
    ...
    #Personal Space as gaussian for each persons
# Mean vector and covariance matrix
mu = np.array([-50., 200.])
#Sigma = np.array([[ 1. , -0.5], [-0.5,  1.]])
#Sigma = np.array([[ 1. , 0.], [0.,  1.]])

covariance = params_conversion(50,37.5,0)
Sigma = covariance

mu1 = np.array([50., 200.])
Sigma1 = params_conversion(50,37.5,3.14)
