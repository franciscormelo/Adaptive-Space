...
class SpaceModeling:
    ...
    def solve(self):
        ...
        plot_ellipse(semimaj=group_radius - 20, semimin=group_radius - 20, x_cent=self.group_pose[0],
        ...
        plot_ellipse(semimaj=group_radius, semimin=group_radius, x_cent=self.group_pose[0],
                            y_cent=self.group_pose[1], ax=ax, plot_kwargs=plot_kwargs)
        data = plot_ellipse(semimaj=group_radius, semimin=group_radius, x_cent=self.group_pose[0],
